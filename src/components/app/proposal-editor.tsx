    ...
    <div className="space-y-8">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Button type="button" variant="outline" onClick={send} disabled={pending} className="h-10 px-4">
            Send
          </Button>
          <Button
            type="button"
      ...
      <form action={generate} className="space-y-3 rounded-2xl border border-border bg-card p-5">
        ...
        <p className="text-sm text-muted-foreground">
          The model may only use this brief. Missing commercial facts become [PLACEHOLDER]. Requires
          OPENAI_API_KEY.
        </p>
        <Textarea
          name="brief"
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Button type="button" onClick={saveSections} disabled={pending} className="h-9 px-4">
            Save sections
          </Button>
        </div>
